...
module Organization
  ...
  ITEMS = {
      ...
      org2: {name: 'Organization 2', inst_code: 'INST2', ingest_dir: '/org2', description: 'organization 2',
             upload_areas: {
                 'upload' => {'type' => 'ntfs', 'location' => '/upload/org2'},
                 'ftp' => {'type' => 'ftp'}
             }
      },
  ...
  TESTS = {
      ...
      create: {
          # 'minimal item' => {
          #     params: ITEMS[:org1],
          #     check_params: ITEMS[:org1].merge(ingest_dir: nil, description: nil, upload_areas: {})
          # },
          # 'full item' => {
          #     params: ITEMS[:org2]
          # },
      ...
      update: {
          ...
          'remove upload_areas' => {
              ...
              params: {upload_areas: nil},
              check_params: ITEMS[:org2].merge(upload_areas: {})
          },
          'empty upload_areas' => {
              init: Proc.new do |ctx, spec|
                spec[:id] = ctx.create_class.(*build_params(ITEMS[:org2]))[model_param].id
